  ...
  const NESTED_TEXT_FORMAT_SHORTCUTS = [
    {
      html: html`
        <p
          ...
          dir="ltr">
          <strong
            class="YsEditorTheme__textBold YsEditorTheme__textItalic YsEditorTheme__textStrikethrough"
            data-lexical-text="true">
            hello world
          </strong>
          <span data-lexical-text="true">!</span>
    ...
    },
    {
      html: html`
        <p
          ...
          dir="ltr">
          <em
            class="YsEditorTheme__textItalic YsEditorTheme__textStrikethrough"
            data-lexical-text="true">
            hello world
          </em>
          <span data-lexical-text="true">!</span>
    ...
    },
    {
      html: html`
        <p
          ...
          dir="ltr">
          <strong
            class="YsEditorTheme__textBold YsEditorTheme__textStrikethrough"
            data-lexical-text="true">
            hello world
          </strong>
          <span data-lexical-text="true">!</span>
    ...
    await assertHTML(
      ...
      html`
        <p
          ...
          dir="ltr">
          <strong
            class="YsEditorTheme__textBold YsEditorTheme__textUnderline"
            data-lexical-text="true">
            h
          </strong>
          <strong
            class="YsEditorTheme__textBold YsEditorTheme__textItalic YsEditorTheme__textUnderline"
            data-lexical-text="true">
            e
          </strong>
          <strong
            class="YsEditorTheme__textUnderlineStrikethrough YsEditorTheme__textBold YsEditorTheme__textItalic"
            data-lexical-text="true">
            llo
          </strong>
          <em
...
const TYPED_MARKDOWN_HTML = html`
  <h1 class="YsEditorTheme__h1 YsEditorTheme__ltr" dir="ltr">
  ...
  <p
    ...
    <em class="YsEditorTheme__textItalic" data-lexical-text="true">
      italic
    </em>
    <span data-lexical-text="true">,</span>
    <em class="YsEditorTheme__textItalic" data-lexical-text="true">
    ...
    <span data-lexical-text="true">,</span>
    <strong class="YsEditorTheme__textBold" data-lexical-text="true">
      bold
    </strong>
    <span data-lexical-text="true">,</span>
    <strong class="YsEditorTheme__textBold" data-lexical-text="true">
    ...
    <span data-lexical-text="true">,</span>
    <span
      class="YsEditorTheme__textStrikethrough"
      data-lexical-text="true">
      strikethrough
    </span>
  ...
  <p
    ...
    <span data-lexical-text="true">This is</span>
    <strong
      class="YsEditorTheme__textBold YsEditorTheme__textStrikethrough YsEditorTheme__textItalic"
      data-lexical-text="true">
  ...
  <h2 class="YsEditorTheme__h2 YsEditorTheme__ltr" dir="ltr">
...
const IMPORTED_MARKDOWN_HTML = html`
  ...
  <h3 class="YsEditorTheme__h3 YsEditorTheme__ltr" dir="ltr">
  ...
  <h4 class="YsEditorTheme__h4 YsEditorTheme__ltr" dir="ltr">
    <span data-lexical-text="true">h4 Heading</span>
  </h4>
  <h5 class="YsEditorTheme__h5 YsEditorTheme__ltr" dir="ltr">
    <span data-lexical-text="true">h5 Heading</span>
  </h5>
  <h6 class="YsEditorTheme__h6 YsEditorTheme__ltr" dir="ltr">
  ...
  <ul class="YsEditorTheme__ul">
    <li
      ...
      <code data-lexical-text="true">
        <span class="YsEditorTheme__textCode">+</span>
      </code>
      <span data-lexical-text="true">,</span>
      <code data-lexical-text="true">
        <span class="YsEditorTheme__textCode">-</span>
  ...
  <ol class="YsEditorTheme__ol1">
    <li
      ...
      <code data-lexical-text="true">
        <span class="YsEditorTheme__textCode">1.</span>
      </code>
    </li>
    <li
      value="2"
      class="YsEditorTheme__listItem YsEditorTheme__nestedListItem">
      <ol class="YsEditorTheme__ol2">
        <li
          value="1"
          class="YsEditorTheme__listItem YsEditorTheme__ltr"
          dir="ltr">
  ...
  <ol start="31" class="YsEditorTheme__ol1">
    <li
      value="31"
      class="YsEditorTheme__listItem YsEditorTheme__ltr"
      dir="ltr">
  ...
  <p
    ...
    <code data-lexical-text="true">
      <span class="YsEditorTheme__textCode">code</span>
    </code>
    <span data-lexical-text="true">format which also</span>
    <code data-lexical-text="true">
      <span class="YsEditorTheme__textCode">
  ...
  <code
    ...
    data-gutter="123">
    <span class="YsEditorTheme__tokenComment" data-lexical-text="true">
      // Some comments
    </span>
    <br />
    <span class="YsEditorTheme__tokenProperty" data-lexical-text="true">
      1
    </span>
    <span data-lexical-text="true"></span>
