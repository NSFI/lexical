...
function Uploader(options) {
  ...
  service = {
    ...
    addFile: function (file, callback) {
      if (file) {
        let fileKey = md5(file.name + ':' + file.size).toString(),
          fileObj;
    ...
    upload: function (param, callback) {
      ...
      let curFile = service.uploadFile;
